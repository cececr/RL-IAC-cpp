...
public:
    ...
    ~CvGabor2();
     ...
     CvGabor2(int iMu, int iNu);
     CvGabor2(int iMu, int iNu, float dSigma);
     CvGabor2(int iMu, int iNu, float dSigma, float dF);
     CvGabor2(float dPhi, int iNu);
     CvGabor2(float dPhi, int iNu, float dSigma);
     CvGabor2(float dPhi, int iNu, float dSigma, float dF);
    bool IsInit();
    long mask_width();
