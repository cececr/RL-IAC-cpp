...
/*!
    \fn CvGabor2::CvGabor2(int iMu, int iNu)
Construct a gabor
 ...
 */
 CvGabor2::CvGabor2(int iMu, int iNu)
{
...
/*!
    \fn CvGabor2::CvGabor2(int iMu, int iNu, double dSigma)
Construct a gabor
 ...
 */
CvGabor2::CvGabor2(int iMu, int iNu, float dSigma)
{ 
    F = sqrt(2.0);
...
/*!
    \fn CvGabor2::CvGabor2(int iMu, int iNu, double dSigma, double dF)
Construct a gabor
 ...
 */
 CvGabor2::CvGabor2(int iMu, int iNu, float dSigma, float dF)
{
...
/*!
    \fn CvGabor2::CvGabor2(double dPhi, int iNu)
Construct a gabor
 ...
 */
 CvGabor2::CvGabor2(float dPhi, int iNu)
{
...
/*!
    \fn CvGabor2::CvGabor2(double dPhi, int iNu, double dSigma)
Construct a gabor
 ...
 */
 CvGabor2::CvGabor2(float dPhi, int iNu, float dSigma)
{
...
/*!
    \fn CvGabor2::CvGabor2(double dPhi, int iNu, double dSigma, double dF)
Construct a gabor
 ...
 */
 CvGabor2::CvGabor2(float dPhi, int iNu, float dSigma, float dF)
{
...
/*!
    \fn CvGabor2::get_image(int Type)
 ...
 */
IplImage* CvGabor2::get_image(int Type)
{
...
/*!
    \fn CvGabor2::Init(int iMu, int iNu, double dSigma, double dF)
Initilize the.gabor
 ...
 */
void CvGabor2::Init(int iMu, int iNu, double dSigma, double dF)
{
  //Initilise the parameters 
    bInitialised = FALSE;
    bKernel = FALSE;
...
/*!
    \fn CvGabor2::Init(double dPhi, int iNu, double dSigma, double dF)
Initilize the.gabor
 ...
 */
void CvGabor2::Init(double dPhi, int iNu, double dSigma, double dF)
{
...
/*!
    \fn CvGabor2::get_matrix(int Type)
 ...
 */
CvMat* CvGabor2::get_matrix(int Type)
{
...
/*!
    \fn CvGabor2::output_file(const char *filename, Gan_ImageFileFormat file_format, int Type)
 ...
 */
void CvGabor2::output_file(const char *filename, int Type)
{
  IplImage *pImage;
...
/*!
    \fn CvGabor2::show(int Type)
 */
void CvGabor2::show(int Type)
{
    if(!IsInit()) {
...
/*!
    \fn CvGabor2::conv_img(IplImage *src, IplImage *dst, int Type)
 */
void CvGabor2::conv_img(IplImage *src, IplImage *dst, int Type)
{
    double ve, re,im;
